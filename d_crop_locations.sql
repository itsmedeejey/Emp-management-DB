...
CREATE TABLE locations (
  ...
  CONSTRAINT locations_ibfk_1 FOREIGN KEY (dept_number) REFERENCES department (dept_number) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO locations VALUES ('Mumbai',1),('Bhopal',2),('Bhopal',3),('Nagpur',4),('Jaipur',5),('Ludhiana',6),('Nashik',7),('Rajkot',8);
